      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3 text-zinc-600 dark:text-zinc-400">
          <a
            ...
            className="p-2.5 rounded-xl hover:bg-zinc-200/60 dark:hover:bg-zinc-800/80 hover:text-zinc-900 dark:hover:text-white transition-all duration-300 ease-in-out hover:scale-110 active:scale-95"
          >
        ...
        >
          ...
          <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800/80 flex items-center justify-around text-zinc-600 dark:text-zinc-400 py-1">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-zinc-950 dark:hover:text-white transition-all duration-200 ease-in-out"
              aria-label="Behance"
            >
