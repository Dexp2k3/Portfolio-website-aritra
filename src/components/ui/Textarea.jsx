  ...
  return (
    <div className="w-full space-y-1.5">
      ...
      <textarea
        ...
        className={cn(
          'w-full px-3.5 py-2.5 rounded-xl text-sm bg-white dark:bg-zinc-900 border transition-all text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 resize-y shadow-sm dark:shadow-none',
